        ...
        for i in tokenized:
            ...
            for row in array:
                for i in range(len(row)):
                    if (row[i] == 'JJ' or row[i]=='JJR' or row[i]=='JJS' or row[i]=='VBG' or row[i]=='MD' or row[i]=='PRP'
                        or row[i]=='VB' or row[i]=='VBN' or row[i]=='NNS' or row[i]=='NNP' or row[i]=='WP' or row[i]=='WRB'):
                        row[1]='NN'
            ...
            for row in words[j]:
                ...
                for i in range(len(my_list)):                    
                    if (my_list[i] == 'JJ' or my_list[i]=='JJR' or
                        my_list[i]=='JJS' or my_list[i]=='VBG' or my_list[i]=='MD' or my_list[i]=='WP' or my_list[i]=='WRB' or
                        my_list[i]=='VB' or my_list[i]=='VBN' or my_list[i]=='PRP$' or my_list[i]=='NNS' or my_list[i]=='NNP' or my_list[i]=='PRP'):
                        my_list[1]='NN'
...
def response_struct(prediction,key_words,key_words_stop,key,Comb_Array,statement):
        ...
        if 8 in count or 9 in count or 10 in count or 7 in count or 6 in count or 5 in count:
            ...
            if len(key_words)==1:
                ...
                vectorizer = CountVectorizer()
                count1 = vectorizer.fit_transform(df_test['key'].values)
                classifier = MultinomialNB()
                target = df_test['B'].values    
                classifier.fit(count1,target)
